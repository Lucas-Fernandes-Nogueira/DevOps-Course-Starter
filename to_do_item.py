...
class ToDoItem:
    ...
    def parse_json_to_do_item(cls, json_item):
        return cls(str(json_item['_id']), json_item['task'], Status.TODO, cls.parse_date_from_json_item(json_item))

    @classmethod
    def parse_json_doing_item(cls, json_item):
        return cls(str(json_item['_id']), json_item['task'], Status.DOING, cls.parse_date_from_json_item(json_item))

    @classmethod
    def parse_json_done_item(cls, json_item):
        return cls(str(json_item['_id']), json_item['task'], Status.DONE, cls.parse_date_from_json_item(json_item)) 
